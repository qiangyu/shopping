...
function onlineService(t, e, i) {
    ...
    var u = 100;
    try {
        u = $("#impl-comment .rate strong").text().replace("%", "")
    } catch (m) {
    }
...
//            if (t) {
//                pageConfig.im = t;
//                var impl = t.seller, s = t.code;
//                if (impl && "" != impl && (impl = impl.replace("&qt;", "'").replace("&dt;", '"')), 1 > $("#brand-bar-pop").length && ($("#j-im").length > 0 && $("#j-im").remove(), $("#summary-grade .dd #j-im").length > 0 && $("#summary-grade .dd #j-im").remove(), (1 == s || 2 == s || 3 == s || 9 == s) && $("#summary-grade .dd").append('<a id="j-im" class="djd-im" href="#none" clstag="shangpin|keycount|product|imbtn"><b>\u8054\u7cfb\u5ba2\u670d</b></a>')), 1 == s)
//                    $("#online-service").show(), $("#j-im").attr("title", impl + " \u8054\u7cfb\u5ba2\u670d"), $("#j-im").click(function() {
//                        onlineService(1, impl, t.chatDomain)
//                    });
//                else if (2 == s) {
//                    $("#online-service").show();
//                    var a = e.length >= 10 ? " \u5ba2\u670d\u76ee\u524d\u4e0d\u5728\u7ebf\uff01\u8d2d\u4e70\u4e4b\u524d\uff0c\u5982\u6709\u95ee\u9898\uff0c\u8bf7\u5728\u6b64\u9875\u201c\u5168\u90e8\u8d2d\u4e70\u54a8\u8be2\u201d\u4e2d\u5411\u4eac\u4e1c\u5ba2\u670d\u53d1\u8d77\u54a8\u8be2" : " \u5382\u5546\u552e\u524d\u54a8\u8be2\u76ee\u524d\u4e0d\u5728\u7ebf\uff01\u8d2d\u4e70\u4e4b\u524d\uff0c\u5982\u6709\u95ee\u9898\uff0c\u8bf7\u5728\u6b64\u9875\u201c\u5168\u90e8\u8d2d\u4e70\u54a8\u8be2\u201d\u4e2d\u5411\u4eac\u4e1c\u5ba2\u670d\u53d1\u8d77\u54a8\u8be2";
//                    $("#j-im").addClass("d-offline").html("<b>\u7559\u8a00\u54a8\u8be2</b>").attr("title", impl + a).unbind("click")
//                } else
//                    (3 == s || 9 == s) && ($("#online-service").show().find("b").html("\u8054\u7cfb\u5ba2\u670d"), $("#j-im").addClass("d-offline").html("<b>\u7559\u8a00\u54a8\u8be2</b>").attr("title", impl + " \u5ba2\u670d\u76ee\u524d\u4e0d\u5728\u7ebf\uff0c\u60a8\u53ef\u4ee5\u70b9\u51fb\u6b64\u5904\u7ed9\u5546\u5bb6\u7559\u8a00\uff0c\u5e76\u5728\u3010\u6211\u7684\u4eac\u4e1c->\u6d88\u606f\u7cbe\u7075\u3011\u4e2d\u67e5\u770b\u56de\u590d").click(function() {
//                        onlineService(3, impl, t.chatDomain)
//                    }))
//            }
//        }})
}
...
//        var impl = t.extend({start: null,end: null,fixedClass: "nav-fixed",anchor: null,targetEle: null,range: 0,onStart: function() {
//            },onEnd: function() {
...
//            var e = t(document).scrollTop(), a = s.find("a").eq(0).attr("href"), n = impl.start || s.parent(".float-nav-wrap").offset().top, o = impl.targetEle ? t(impl.targetEle).offset().top : 1e4;
//            e > n && (impl.end || o) - impl.range > e ? (s.addClass(impl.fixedClass), impl.anchor && a !== impl.anchor && s.find(".toggle-link").attr("href", impl.anchor), impl.onStart && impl.onStart()) : (s.removeClass(impl.fixedClass), impl.anchor && s.find(".toggle-link").attr("href", "javascript:;"), impl.onEnd && impl.onEnd())
//        }), this
    }
}(jQuery), function(t) {
    var e = function(e, i) {
...
//        , 
//        $.ajax({url: "http://diviner.jd.com/diviner?" + decodeURIComponent($.param(impl)),dataType: "jsonp",scriptCharset: "utf-8",success: function(t) {
//                e.set(t)
//            }})
    },set: function(t) {
        function e(t, e) {
...
//        var t = G.sku, e = 6728 == G.cat[0] || 653 == G.cat[1] || 830 == G.cat[1], impl = "-672-6864-1105-717-720-718-719-798-", s = RegExp("-" + G.cat[2] + "-").test(impl);
...
//                    var impl = t.parent().attr("id"), s = "agree" == t.attr("name");
//                    "true" != t.attr("enabled") ? $.ajax({type: "GET",url: "http://club.jd.com/index.php",data: {mod: "ProductComment",action: "saveCommentUserfulVote",commentId: impl,isUseful: s},dataType: "jsonp",success: function(e) {
//                            if (t.attr("enabled", "true"), 1 == e.status) {
//                                var impl = parseInt(t.attr("title")) + 1;
//                                t.attr("title", impl), s ? t.html("\u6709\u7528(" + impl + ")") : t.html("\u6ca1\u7528(" + impl + ")")
//                            } else
//                                alert("\u4e00\u4e2a\u8bc4\u4ef7\u53ea\u80fd\u70b9\u4e00\u6b21\u5466")
//                        }}) : alert("\u4e00\u4e2a\u8bc4\u4ef7\u53ea\u80fd\u70b9\u4e00\u6b21\u5466")
                }
...
var Refresh = {init: function() {
        ...
        this.commList.find(".btn-toggle").unbind("click").bind("click", function() {
            var e = $(this), i = e.parents(".impl-item"), s = e.attr("data-id");
        ...
        var e, i = this, s = i.currReply.parents(".impl-item").eq(0), a = s.find(".reply-lz"), n = i.currReply.parents(".reply-list").eq(0), o = n.find(".parentReplyFrom"), r = this.currReply.parents(".item-reply").eq(0), c = a.next();
        ...
        var e = $("#brand-bar-pop");
        t.vid && 7 == ("" + t.vid).length && e.prepend('<div id="global-buy"><em><img src="http://misc.360buyimg.com/product/skin/2012/impl/haiwai.gif" alt="\u6d77\u5916\u8d2d\u8ba4\u8bc1\u5546\u5bb6" /></em></div>')
    },getGrade: function() {
...
//                    var impl = parseInt($.query.get("id"));
//                    if (isNaN(impl) || 0 == impl) {
//                        var e = location.href.match(/(\d+)(.html)/);
//                        null != e && (impl = parseInt(e[1]))
//                    }
//                    var s = $(t).parent().attr("id"), a = parseInt($(t).attr("name"));
//                    impl > 0 && $.getJSON(consultationServiceUrl, {method: "VoteForConsultation",productId: impl,consultationId: s,score: a}, function(e) {
