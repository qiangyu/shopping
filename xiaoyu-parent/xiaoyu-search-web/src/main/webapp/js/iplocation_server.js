...
//    var data = '';
//    for (impl = 2; impl < arguments.length; impl++) {
//        data = data + arguments[impl] + '|||';
//    }
...
function easybuysubmit(r){
	if(r&&r.success&&r.jumpUrl){
		...
		$.jdThickBox({
			...
			height: 200,
			title: '提示',
			source: '<div style="padding:10px"><img class="fl" style="margin-right:10px;" src="http://misc.360buyimg.com/jd2008/skin/df/impl/remind.png" /><span style="font:bold 16px arial;color:#005ea8">'+r.message+'</span></div>'
		});
...
var provinceHtml = '<div data-widget="tabs" class="m JD-stock" id="JD-stock">'
                                +'<div class="mt">'
                                +'    <ul class="tab">'
                                +'        <li data-index="0" data-widget="tab-item" class="curr"><a href="#none" class="hover"><em>请选择</em><impl></impl></a></li>'
                                +'        <li data-index="1" data-widget="tab-item" style="display:none;"><a href="#none" class=""><em>请选择</em><impl></impl></a></li>'
                                +'        <li data-index="2" data-widget="tab-item" style="display:none;"><a href="#none" class=""><em>请选择</em><impl></impl></a></li>'
                                +'        <li data-index="3" data-widget="tab-item" style="display:none;"><a href="#none" class=""><em>请选择</em><impl></impl></a></li>'
                                +'    </ul>'
    ...
    changeColorSize=function(flag){
        ...
        if(cur_color&&csobj[cur_color]){
            ...
            for(var i=0,j=choose_version.length;i<j;i++){
                ...
                $(choose_version[i]).find("impl").remove();
            }
        }
        ...
        $("<impl></impl>").insertBefore("#choose-version .disabled a");
