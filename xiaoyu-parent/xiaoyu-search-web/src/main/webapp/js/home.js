...
(function() {
    ...
    new BackPanelNew({id: "backpanel0708",start: 10}).init({text: "\u8fd4\u56de\u9876\u90e8",fn: function() {
        ...
        var t = $("#shortcut-2013 .fl").eq(0).find(".fore1"), e = '            <li class="fore2 jd-wx-qrcode">                <a href="#none"><impl class="impl-qrcode"></impl>\u5173\u6ce8\u4eac\u4e1c</a>                <div class="qrcode-show">                    <span class="arrow">                        <impl class="layer1"></impl><impl class="layer2"></impl>                    </span>                </div>            </li>';
