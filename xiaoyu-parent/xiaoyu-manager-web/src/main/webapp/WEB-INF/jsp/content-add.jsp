...
<div style="padding:10px 10px 10px 10px">
	<form id="contentAddForm" class="itemForm" method="post">
		<input type="hidden" name="categoryId"/> <%--这隐藏域存放的是内容分类的id--%>
	    <table cellpadding="5">
	        <tr>
	            <td>内容标题:</td>
...
<script type="text/javascript">
	...
	$(function(){
		// 初始化富文本编辑器  放到name=content的textarea中
		contentAddEditor = TT.createEditor("#contentAddForm [name=content]");
		TT.initOnePicUpload();
		// $("#contentCategoryTree").tree("getSelected").id  被选中的树的节点 的id 的值 设置到隐藏域中
